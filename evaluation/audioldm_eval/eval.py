...
class EvaluationHelper:
    ...
    def calculate_metrics(
        ...
        val_fad = out.get("frechet_audio_distance", float("nan"))
        val_fd = out.get("frechet_distance", float("nan"))
        val_kl = out.get("kullback_leibler_divergence_softmax", float("nan"))
        val_is_mean = out.get("inception_score_mean", float("nan"))
